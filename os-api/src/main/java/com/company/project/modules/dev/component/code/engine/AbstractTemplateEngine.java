...
import com.company.project.modules.dev.component.code.config.TemplateConfig;
import com.company.project.modules.dev.component.code.config.po.TableInfo;
import com.company.project.modules.dev.component.code.config.rules.FileType;
import com.company.project.modules.dev.component.code.InjectionConfig;
import com.company.project.modules.dev.component.code.config.ConstVal;
import com.company.project.modules.dev.component.code.config.FileOutConfig;
    ...
    public AbstractTemplateEngine batchOutput() {
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                // page.vue
                if (template.getVue() != null) {
                    String controllerFile = String.format((pathInfo.get(ConstVal.CONTROLLER_PATH) + File.separator + tableInfo.getEntityName().toLowerCase() +".vue"));
                    writer(objectMap, templateFilePath(template.getVue()), controllerFile);
                }

                if (template.getJs() != null) {
                    String controllerFile = String.format((pathInfo.get(ConstVal.CONTROLLER_PATH) + File.separator + tableInfo.getEntityName().toLowerCase() +".js"));
                    writer(objectMap, templateFilePath(template.getJs()), controllerFile);
                }
