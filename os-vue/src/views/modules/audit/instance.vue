  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="备注" prop="data.content" />
        <el-table-column label="申请时间" prop="data.startTime" />
        <el-table-column label="类型" prop="data.leaveType" />
...
<script>
import { getList, apply, approve } from '@/api/audit/instance'
