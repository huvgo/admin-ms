  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="请求地址" prop="content.url" />
        <el-table-column label="请求方法" prop="content.method" width="100" />
        <el-table-column label="请求参数" prop="content.params" />
        <el-table-column label="执行时长(毫秒)" prop="content.time" width="120" />
...
<script>
import { add, del, update, getList } from '@/api/system/log'
